...
export const chatMicIcon = (w?: any, h?: any, color?: any) => {
  const xml = `<svg width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15 10V11C15 14.866 11.866 18 8 18M1 10V11C1 14.866 4.13401 18 8 18M8 18V21M8 21H11M8 21H5M8 15C5.79086 15 4 13.2091 4 11V5C4 2.79086 5.79086 1 8 1C10.2091 1 12 2.79086 12 5V11C12 13.2091 10.2091 15 8 15Z" stroke=${
    color ?? 'white'
  } style="stroke:white;stroke-opacity:1;" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
export const chatNoteIcon = (w?: any, h?: any, color?: any) => {
...
<path d="M5 17L5 9C5 6.79086 6.79086 5 9 5L15 5M5 17C5 19.2091 6.79086 21 9 21H11.3431C12.404 21 13.4214 20.5786 14.1716 19.8284L17.8284 16.1716C18.5786 15.4214 19 14.404 19 13.3431V9C19 6.79086 17.2091 5 15 5M5 17C2.79086 17 1 15.2091 1 13L1 5C1 2.79086 2.79086 1 5 1L11 1C13.2091 1 15 2.79086 15 5M13 21V19C13 16.7909 14.7909 15 17 15H19" stroke=${
    color ?? '#797C7B'
  } style="stroke:#797C7B;stroke:color(display-p3 0.4745 0.4863 0.4824);stroke-opacity:1;" stroke-width="1.5" stroke-linejoin="round"/>
</svg>
`;
...
export const menuwithDotsIcon = (w?: any, h?: any, color?: any) => {
...
export const liveStreamBackIcon = (w?: any, h?: any, color?: any) => {
  const xml = `<svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.6667 1.33301L20.3333 1.33301C24.4103 1.33301 24.3333 6.66634 24.3333 11.9997C24.3333 17.333 24.4103 22.6663 20.3333 22.6663H15.6667M1 11.9997L17 11.9997M1 11.9997L6.33333 6.66634M1 11.9997L6.33333 17.333" stroke=${
    color ?? 'white'
  } style="stroke:white;stroke-opacity:1;" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<path d="M1.3335 14.6663H22.6668M1.3335 7.99967H22.6668M1.3335 1.33301H22.6668" stroke=${
    color ?? 'white'
  } style="stroke:white;stroke-opacity:1;" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
export const viewIcon = (w?: any, h?: any, color?: any) => {
  const xml = `<svg width="26" height="22" viewBox="0 0 26 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13 1.66699C7.99015 1.66699 4.24803 4.92086 2.02316 7.58612C0.353608 9.58614 0.353608 12.4145 2.02316 14.4145C4.24803 17.0798 7.99015 20.3337 13 20.3337C18.0099 20.3337 21.752 17.0798 23.9769 14.4145C25.6464 12.4145 25.6464 9.58614 23.9769 7.58612C21.752 4.92086 18.0099 1.66699 13 1.66699Z" stroke="white" style="stroke:white;stroke-opacity:1;" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13 15.0003C15.2091 15.0003 17 13.2095 17 11.0003C17 8.79119 15.2091 7.00033 13 7.00033C10.7909 7.00033 9 8.79119 9 11.0003C9 13.2095 10.7909 15.0003 13 15.0003Z" stroke=${
    color ?? 'white'
  } style="stroke:white;stroke-opacity:1;" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<path d="M7.18439 8.65781L13.8124 5.34378M13.8156 14.6578L7.19379 11.3469M19.5 4C19.5 5.65685 18.1569 7 16.5 7C14.8431 7 13.5 5.65685 13.5 4C13.5 2.34315 14.8431 1 16.5 1C18.1569 1 19.5 2.34315 19.5 4ZM7.5 10C7.5 11.6569 6.15685 13 4.5 13C2.84315 13 1.5 11.6569 1.5 10C1.5 8.34315 2.84315 7 4.5 7C6.15685 7 7.5 8.34315 7.5 10ZM19.5 16C19.5 17.6569 18.1569 19 16.5 19C14.8431 19 13.5 17.6569 13.5 16C13.5 14.3431 14.8431 13 16.5 13C18.1569 13 19.5 14.3431 19.5 16Z" stroke=${
    color ?? '#7C7C7C'
  } style="stroke:#7C7C7C;stroke:color(display-p3 0.4863 0.4863 0.4863);stroke-opacity:1;" stroke-width="1.5"/>
</svg>
`;
